...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'tenant_id', 'name', 'slug', 'slug_ci', 'parent_id', 'created_at', 'updated_at', 'version', 'deleted_at', 'is_live' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\Categories\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\Categories\Definitions::softDeleteColumn();
