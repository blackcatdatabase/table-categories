 ...
 * - whitelist filtrů: [ 'id', 'name', 'slug', 'parent_id', 'created_at', 'updated_at', 'version', 'deleted_at' ]
 * - whitelist LIKE:   [ 'name', 'slug' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'name', 'slug', 'parent_id', 'created_at', 'updated_at', 'version', 'deleted_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'name', 'slug', 'parent_id', 'created_at', 'updated_at', 'version', 'deleted_at' ], true);
            $parts = [];
