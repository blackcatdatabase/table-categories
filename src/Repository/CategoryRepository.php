...
final class CategoryRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`categories`' : '"categories"';
     ...
     * [ 'name', 'parent_id', 'updated_at', 'deleted_at' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $keys = [ 'slug' ];
        $upd  = [ 'name', 'parent_id', 'updated_at', 'deleted_at' ];
