...
namespace BlackCat\Database\Packages\Categories\Repository;

use BlackCat\Core\Database as Database;              // e.g. BlackCat\Core\Database
use BlackCat\Database\Packages\Categories\Definitions;
use BlackCat\Database\Packages\Categories\Criteria;
use BlackCat\Database\Packages\Categories\Dto\CategoryDto as Dto;
use BlackCat\Database\Packages\Categories\Mapper\CategoryDtoMapper as RowMapper;
...
final class CategoryRepository implements RepoContract, KeysetRepoContract
{
     ...
     */
    protected function def(): string { return \BlackCat\Database\Packages\Categories\Definitions::class; }
    ...
    private function doUpsert(array $row, bool $revive): void
    {
        ...
        $updCols = [ 'name', 'parent_id', 'updated_at', 'version', 'deleted_at' ];
    ...
    public function upsertMany(array $rows): int {
        ...
        if (class_exists(\BlackCat\Database\BulkUpsertRepository::class) && [ 'tenant_id', 'slug_ci' ] !== []) {
            $bulk = new \BlackCat\Database\BulkUpsertRepository($this->db, \BlackCat\Database\Packages\Categories\Definitions::table());
            return $bulk->upsertMany($rows, [ 'tenant_id', 'slug_ci' ], [ 'name', 'parent_id', 'updated_at', 'version', 'deleted_at' ]);
        }
    ...
    */
    ...
    public function getByTenantIdAndSlugCiAndIsLive(int $tenantId, string $slugCi, int $isLive, bool $asDto = false): array|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null {
        ...
        if (!$asDto || !$row) return $row;
        return \BlackCat\Database\Packages\Categories\Mapper\CategoryDtoMapper::fromRow($row);
    }
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null */
    public function getByTenantIdAndId(int $tenantId, int $id, bool $asDto = false): array|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null {
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null */
    public function getById(int $id, bool $asDto = false): array|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null {
    ...
    /** @return array<string,mixed>|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null */
    public function getByIdForTenant(int|string $id, int|string $tenantId, bool $asDto = false): array|\BlackCat\Database\Packages\Categories\Dto\CategoryDto|null {
