...
namespace BlackCat\Database\Packages\Categories\Joins;
...
final class CategoriesJoins {
     ...
     * LEFT JOIN vw_categories AS $as ON $as.id = $alias.parent_id
     * @return array{0:string,1:array}
     */
    public function joinCategories(string $alias = 't', string $as = 'j0'): array {
        [$alias, $as] = $this->assertAliasPair($alias, $as);
        return [' LEFT JOIN vw_categories AS ' . $as . ' ON ' . $as . '.id = ' . $alias . '.parent_id' . ' ', []];
    }
