...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'name', 'slug', 'parent_id', 'created_at', 'updated_at', 'version', 'deleted_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'parent_id', 'version' ]; }
