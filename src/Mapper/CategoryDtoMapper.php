...
namespace BlackCat\Database\Packages\Categories\Mapper;

use BlackCat\Database\Packages\Categories\Dto\CategoryDto;
use BlackCat\Database\Packages\Categories\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO CategoryDto:
...
final class CategoryDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'tenant_id' => 'tenantId', 'slug_ci' => 'slugCi', 'parent_id' => 'parentId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt', 'deleted_at' => 'deletedAt', 'is_live' => 'isLive' ];
    ...
    public static function fromRowOrNull(?array $row): ?CategoryDto
    {
     ...
     */
    public static function toRow(CategoryDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CategoryDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CategoryDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CategoryDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CategoryDto>
     */
