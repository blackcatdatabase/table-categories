...
final class CategoryDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'parent_id' => 'parentId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt', 'deleted_at' => 'deletedAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'parent_id' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'parent_id', 'deleted_at' ];
