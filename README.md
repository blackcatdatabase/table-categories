...
> 🔥 Lineage hotspot: 5 FK links detected. Make sure cascades/nullability are intentional.
...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 3 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\categories](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\categories)
...
graph LR
  ...
  categories -->|FK| categories["categories"]:::link
  categories -->|FK| tenants["tenants"]:::accent
  book_categories["book_categories"]:::inbound -->|FK| categories
  books["books"]:::inbound -->|FK| categories
  categories["categories"]:::inbound -->|FK| categories
...
- Outbound (depends on): "categories", "tenants"
- Inbound (relies on this): "book_categories", "books", "categories"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package categories -Apply
