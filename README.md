...
> Lineage: 2 outbound / 3 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (0 d)
...
| Pkg folder | [packages\categories](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\categories) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package categories -Apply
